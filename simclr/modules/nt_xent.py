...
class NT_Xent_With_Neg_Samples(nn.Module):
    ...
    def forward(self, z_i, z_j, z_neg):
        ...
        sim_i_j = torch.diag(sim, self.batch_size * self.world_size)[:self.batch_size * self.world_size]
        sim_j_i = torch.diag(sim, -self.batch_size * self.world_size)[:self.batch_size * self.world_size]
